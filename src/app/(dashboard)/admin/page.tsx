      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <Button className="flex items-center gap-2 bg-gradient-to-r from-[#06a6ae] hover:from-[#059298] to-[#9AD0D3] hover:to-[#88c2c5]">
                  ...
                  {recentActivities.map((activity, index) => (
                    <div key={index} className="flex items-start gap-3 hover:bg-[#06a6ae]/5 p-3 border border-gray-100 hover:border-[#06a6ae]/20 rounded-xl transition-all duration-300">
                      <Avatar className="w-8 h-8">
                        <AvatarFallback className="bg-gradient-to-r from-[#06a6ae] to-[#9AD0D3] text-white text-xs">
                          {activity.avatar}
                        </AvatarFallback>
                      </Avatar>
                      <div className="flex-1 min-w-0">
