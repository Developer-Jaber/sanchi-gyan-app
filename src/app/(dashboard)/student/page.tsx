      ...
      <div className='mx-auto px-6 py-8 max-w-7xl'>
        ...
        >
          ...
          <div className='flex items-center gap-4'>
            <Button variant='secondary' className='relative p-2 rounded-full'>
              <Bell className='w-5 h-5' />
              <span className='-top-1 -right-1 absolute bg-red-500 rounded-full w-3 h-3'></span>
            </Button>
            <Avatar className='border-[#06a6ae] border-2 w-10 h-10'>
              <AvatarImage src='/avatar.jpg' />
              <AvatarFallback className='bg-gradient-to-r from-[#06a6ae] to-[#9AD0D3] text-white'>
                AS
              </AvatarFallback>
            </Avatar>
          </div>
            ...
            >
              <CardContent className='p-6'>
                <div className='flex justify-between items-start'>
                  ...
                  <div className='bg-gradient-to-r from-[#06a6ae] to-[#9AD0D3] p-3 rounded-2xl'>
              ...
              <Card className='bg-white/80 shadow-lg backdrop-blur-sm border-0'>
                ...
                <CardContent className='space-y-4'>
                  {recentAchievements.map((achievement, index) => (
                    ...
                    >
                      <div
                        className={`p-2 rounded-xl bg-gradient-to-r from-[#06a6ae] to-[#9AD0D3]`}
                      >
                        <achievement.icon
