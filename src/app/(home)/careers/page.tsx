...
const jobOpenings = [
  ...
  },
  {
    ...
    deadline: "2024-03-20",
    description: "Create interactive science content and experiments for high school students.",
    requirements: ["M.Sc. in Science", "Content Writing Experience", "Video Production Skills"],
    benefits: ["Remote Work", "Creative Freedom", "Stock Options"],
    urgency: "medium",
    featured: true
  },
  {
    ...
    deadline: "2024-03-25",
    description: "Build amazing learning experiences with React, Next.js, and modern web technologies.",
    requirements: ["React/Next.js Expertise", "TypeScript", "UI/UX Sense", "Problem Solving"],
    benefits: ["Latest Tech", "Learning Budget", "Flexible Schedule"],
    urgency: "high",
    featured: false
  },
  {
    ...
    deadline: "2024-03-18",
    description: "Support students in their learning journey and ensure their success.",
    requirements: ["Communication Skills", "Education Background", "Empathy", "Problem Solving"],
    benefits: ["Student Interaction", "Growth Opportunities", "Impactful Work"],
    urgency: "medium",
    featured: false
  },
  {
    ...
    deadline: "2024-03-22",
    description: "Create engaging educational videos that make learning fun and effective.",
    requirements: ["Video Editing Skills", "Creative Mindset", "Attention to Detail"],
    benefits: ["Flexible Hours", "Creative Projects", "Skill Development"],
    urgency: "low",
    featured: false
  },
  {
    ...
    deadline: "2024-03-30",
    description: "Design innovative curriculum following Nepali educational standards.",
    requirements: ["Curriculum Design Experience", "Education Degree", "Innovative Thinking"],
    benefits: ["High Impact", "Professional Recognition", "Flexible Schedule"],
    urgency: "medium",
    featured: true
  }
]
            ...
            {filteredJobs.map((job, index) => (
              <motion.div
                ...
                className={`bg-white rounded-2xl shadow-lg hover:shadow-xl border-2 transition-all duration-300 ${
                  selectedJob === job.id ? 'border-[#06a6ae]' : 'border-transparent hover:border-gray-200'
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <Button 
                      ...
                      variant={selectedJob === job.id ? "primary" : "secondary"}
                      className="px-6 py-2"
                    >
                      {selectedJob === job.id ? "Selected" : "View Details"}
                    </Button>
                    <Button className="bg-gradient-to-r from-[#06a6ae] to-[#9AD0D3] px-6 py-2">
                      Apply Now
                    </Button>
                  </div>
                </div>
