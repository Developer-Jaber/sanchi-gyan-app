    ...
    <footer className="bg-gray-900 pt-12 pb-8 text-white">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="gap-8 grid grid-cols-1 md:grid-cols-4">
          <div>
            <h3 className="mb-4 font-bold text-xl">Sanchi Gyan</h3>
            <p className="text-gray-400">
              Empowering learners to achieve their personal and professional goals through high-quality education.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="text-gray-400 not-italic">
              ...
              <p>Learning City, 100001</p>
              <p className="mt-2">Email: info@sanchigyan.com</p>
              <p>Phone: +91 98765 43210</p>
            </address>
          </div>
        </div>
        
        <div className="flex md:flex-row flex-col justify-between items-center mt-8 pt-8 border-gray-800 border-t">
          <p className="text-gray-400 text-sm">© 2023 Sanchi Gyan. All rights reserved.</p>
