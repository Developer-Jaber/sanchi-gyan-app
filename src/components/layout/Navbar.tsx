        ...
        <div className='flex justify-between h-16'>
          ...
          <div className='hidden md:flex items-center space-x-8'>
            ...
            <div className='flex space-x-4'>
              <button className='bg-white hover:bg-gray-100 px-4 py-2 border border-indigo-600 rounded-md font-medium text-indigo-600 text-sm'>
                Login
              </button>
              <button className='bg-indigo-600 hover:bg-indigo-700 px-4 py-2 rounded-md font-medium text-white text-sm'>
                Sign Up
              </button>
            </div>
          </div>
